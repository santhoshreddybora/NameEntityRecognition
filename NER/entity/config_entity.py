...
class DataTransformationConfig:
    def __init__(self):
        self.data_transformation_artifact_dir:str=os.path.join(ARTIFACTS_DIR,DATA_TRANSFORMATION_ARTIFACTS_DIR)
        self.labels_to_ids_path:str=os.path.join(self.data_transformation_artifact_dir,LABELS_TO_IDS_FILE_NAME)
        self.ids_to_labels_path:str=os.path.join(self.data_transformation_artifact_dir,IDS_TO_LABELS_FILE_NAME)
        self.ids_to_labels_gcp_path: str = os.path.join(self.data_transformation_artifact_dir)
        self.df_train_file_path:str=os.path.join(self.data_transformation_artifact_dir,DF_TRAIN_FILE_NAME)
